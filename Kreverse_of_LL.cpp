...
//         curr=forward;
//     }
//     return prev; // kyuki last me prev wala pointer naye wale head pe rahega to us naye head ko retun return krne ke liye
// }
...
int main(){
  ...
  print(head);
  cout<<"here is your revesre of LL by k=2 "<<endl;
